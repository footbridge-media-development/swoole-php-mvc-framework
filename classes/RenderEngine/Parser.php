<?php
	...
	class Parser{
		...
		public function __construct(string $fileLocation, \Swoole\Coroutine\Channel $swooleChannel){
			$this->fileLocation = $fileLocation;
			go(function() use ($swooleChannel, $fileLocation){
